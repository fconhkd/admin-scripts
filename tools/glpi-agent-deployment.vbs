...
'
SetupOptions = "/quiet RUNNOW=1 SERVER='http://glpi.yourcompany.com/plugins/fusioninventory' TAG=COMPANY"
'SetupOptions = "/quiet RUNNOW=1 SERVER='https://glpi.grupocard.net.br/front/inventory.php'"
